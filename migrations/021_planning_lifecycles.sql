...
ALTER TABLE traces
    ADD CONSTRAINT traces_id_space_namespace_unique
    UNIQUE (id, space_id, namespace_id);
...
CREATE TABLE planning_lifecycles (
    ...
    CONSTRAINT planning_lifecycles_trace_same_scope_fkey
        FOREIGN KEY (planning_trace_id, space_id, namespace_id)
