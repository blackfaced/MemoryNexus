...
use image::{imageops::FilterType, GenericImageView, ImageFormat as OutputImageFormat};
...
impl ImageFormat {
    ...
    pub fn to_image_format(&self) -> OutputImageFormat {
        match self {
            ...
            Self::Png => OutputImageFormat::Png,
            Self::Webp => OutputImageFormat::WebP,
            Self::Gif => OutputImageFormat::Gif,
        }
    }
}
...
impl ThumbnailGenerator {
    ...
    pub fn generate(
        ...
        let (new_width, new_height) =
            self.calculate_dimensions(orig_width, orig_height, target_width, target_height);
...
mod tests {
    ...
    fn test_calculate_dimensions() {
        ...
        assert!(w <= 300 && h <= 300);
        assert!(((w as f64 / h as f64) - (1920.0 / 1080.0)).abs() < 0.01);
